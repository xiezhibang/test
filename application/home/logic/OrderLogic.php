...
class OrderLogic extends Model {
     ...
     * @return array
     */
    public function addOrder($user_id, $address_id, $shipping_code, $invoice_title, $coupon_id = 0, $car_price, $user_note = '', $pay_name = '', $quota = 0, $famous_quota = 0) {
        ...
        $data             = [
            ...
            'pay_name'          => $pay_name,//支付方式，可能是余额支付或积分兑换，      后面其他支付方式会替换 // 用户下单备注
            'quota'             => $quota,
            'famous_quota'      => $famous_quota,
        ];
