...
//				)),
	...
	'shop'=>array('name'=>'商城','child'=>array(
				array('name' => '商品','child' => array(
                    ...
                    array('name' => '任领商品列表', 'act'=>'vipGoodsList', 'op'=>'Goods'),
                    array('name' => '尖货特惠', 'act'=>'goodsList', 'op'=>'Goods'),
                    array('name' => '名品商品列表', 'act'=>'famousGoodsList', 'op'=>'Goods'),
                    array('name' => '升级Vip用商品列表', 'act'=>'upVipGoodsList', 'op'=>'Goods'),
...
//					array('name' => '分成日志', 'act'=>'rebate_log', 'op'=>'Distribut'),
    	    ...
    	    array('name' => '微信','child' => array(
                array('name' => '支付设置', 'act'=>'setting&type=payment&code=weixin', 'op'=>'Plugin'),
			...
			array('name' => '统计','child' => array(
                    ...
                    array('name' => '尖货销售', 'act'=>'jianhuo', 'op'=>'Report'),
                    array('name' => 'VIP统计', 'act'=>'viptotal', 'op'=>'Report'),
                    array('name' => '运费概览', 'act'=>'transport', 'op'=>'Report'),
			)),
	)),
